...
function PizzaBlock({id, name, imageUrl, types, sizes, price, onClickAddPizzas, addedPizzas}) {
        ...
        <div class="pizza-block__selector">
          ...
          <ul>
              {availableSizes.map((size, index) => {
                    return <li onClick={() => onSelectSize(index)} className={className({
